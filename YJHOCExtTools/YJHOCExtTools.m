...
+ (NSString *)_iPadPlatform:(NSString *)platform {
    ...
    if([platform isEqualToString:@"Pad8,1 ~ 8,4"])   return @"iPad Pro 11-inch";
    ...
    if ([platform isEqualToString:@"iPad13,4 ~ 13,7"])   return @"iPad Pro 11-inch 3nd gen";
    if ([platform isEqualToString:@"iPad13,8 ~ 13,11"])   return @"iPad Pro 12.9-inch 5th gen";
    ...
    if ([platform isEqualToString:@"iPad13,18"] ||
        [platform isEqualToString:@"iPad13,19"]) return @"iPad 10";
    if ([platform isEqualToString:@"iPad14,3 ~ 14,4"])   return @"iPad Pro 11-inch 4th gen";
    if ([platform isEqualToString:@"iPad14,5 ~ 14,6"])   return @"iPad Pro 12.9-inch 6th gen";
    return @"Unknown iPad";
}
